...
export class Auth0Provider extends Component<{}, IState> {
  ...
  // initialize the auth0 lib
  initializeAuth0 = async () => {
    const auth0Client = await createAuth0Client(this.config);
    this.setState({ auth0Client });

    //  check to see if they have been redirected after the login
  ...
  render() {
    ...
    const configObject = {
      ...
      getTokenSilently: (...p: any) => auth0Client.getTokennSilently(...p),
